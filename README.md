...
* allerA(Distance, Distance)                          ... Ne marche pas, et c'est normal
* allerA(Vector2m)                                    ... Ne marce pas, et c'est normal
* avancerA(Vector2m, SensAvance)                      ... Ok
* avancerA(Vector2m)                                  ... Ok
* reculerA(Vector2m)                                  ...
* bougerObjet(std::string const&, Distance, Distance) ... Ne devrait plus exister...
* recalageMarcheArriere()                             ...
* setVitesseAngulaireLente()                          ... 
* resetVitesseAngulaire()                             ...
* setVitesseLineaireLente()                           ...
* resetVitesseLineaire()                              ...
* setVitesseLineaire(Speed)                           ... Ok
* descendreCuillere()                                 ...
* monterCuillere()                                    ...
* descendrePelle()                                    ...
* monterPelle()                                       ...
