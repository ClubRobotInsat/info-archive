...
static const int positionPinceGaucheAtlas[POSITION_ATLAS_PINCE_NBR] = {1000, 1150, 1250};			// ouvert,  bloque tomate, ferme
static const int positionPinceDroiteAtlas[POSITION_ATLAS_PINCE_NBR] = {2000, 1610,  1710};		// ouvert, bloque tomate, ferme
