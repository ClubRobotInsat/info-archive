...
namespace ConstantesPrincipal {
	...
	Angle const positionPinceD[enumToInt(PositionPince::NBR)] = {160_deg, 60_deg, -10_deg};
	Angle const positionPinceG[enumToInt(PositionPince::NBR)] = {160_deg, 60_deg, -10_deg};
