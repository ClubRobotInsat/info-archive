...
namespace ConstantesPrincipal {
	...
	Angle const positionPinceD[enumToInt(PositionPince::NBR)] = {150_deg, 150_deg, -10_deg};
	Angle const positionPinceG[enumToInt(PositionPince::NBR)] = {150_deg, 150_deg, -10_deg};
