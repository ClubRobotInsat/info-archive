...
static const int positionPinceGauche[POSITION_PINCE_NBR] = {950, 800, 1000, 1210};			// ouvert, bloque tomate, bloque mais, ferme
static const int positionPinceDroite[POSITION_PINCE_NBR] = {2175, 2150, 1950, 1750};		// ouvert, bloque tomate, bloque mais, ferme
// 1995 tomate environ
static const int positionAscenseur[POSITION_ASCENSEUR_NBR] = {-10000, -8000 /* TODO : mettre la bonne valeur*/, -1500}; 		// bas, pos arrachage, haut (position bascule)), hauteur en mm
