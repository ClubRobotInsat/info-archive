...
static const int positionFourcheGauche[POSITION_FOURCHE_NBR] = {900, 1210, 2020, 2060, 2300, 2500}; //tres_bas, bas, milieu, milieu_plus, haut, tres_haut
static const int positionFourcheDroite[POSITION_FOURCHE_NBR] = {2050, 1730, 920, 1100, 650, 500}; //tres_bas, bas, milieu, milieu_plus, haut, tres_haut
