...
Duree const Constantes::TIMEOUT_DEPLACEMENT_DEFAUT = 10_s;
Duree const Constantes::TIMEOUT_BLOCAGE_ADVERSAIRE_DEFAUT = 5_s;
VitesseLineaire const Constantes::VITESSE_LINEAIRE_DEFAUT = 40_cm_s;
VitesseAngulaire const Constantes::VITESSE_ANGULAIRE_DEFAUT = 5_rad_s; // Unité arbitraire décidée en élec.
Distance const Constantes::PRECISION_LINEAIRE_DEFAUT = 4_cm;
Angle const Constantes::PRECISION_ANGULAIRE_DEFAUT = 4_deg;

VitesseLineaire const Constantes::VITESSE_LINEAIRE_EVITEMENT = 20_cm_s;
VitesseAngulaire const Constantes::VITESSE_ANGULAIRE_EVITEMENT = 1_rad_s;

VitesseLineaire const Constantes::VITESSE_LINEAIRE_RECALAGE = 20_cm_s;

Duree const Constantes::DUREE_MATCH = 90_s;
...
Duree ConstantesCommunes::getDureeMatch() const {
