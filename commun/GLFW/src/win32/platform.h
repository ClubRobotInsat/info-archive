...
#define ENTER_THREAD_CRITICAL_SECTION EnterCriticalSection(&_glfwThrd.CriticalSection);
#define LEAVE_THREAD_CRITICAL_SECTION LeaveCriticalSection(&_glfwThrd.CriticalSection);
