...
public:
	Action(CarteDerivee* carte, void (CarteDerivee::*ActualiserFunc)(), TypeRetour (CarteDerivee::*LireValeurFunc)()) : carte(carte), ActualiserFunc(ActualiserFunc), LireValeurFunc(LireValeurFunc) {
