...
#petri/petri --generate --compile --compiler /usr/bin/arm-linux-gnueabihf-g++-5 -v --output ./build_arm/IA2017.so robot/Principal/petri/IA2017.petri 
...
echo "compilation de poser cylindre"
...
echo "gene de posercylindre"
#/usr/bin/arm-linux-gnueabihf-g++-5 -shared -fPIC -L'../Editor/bin' -iquote'../' -I'../' 'poserCylindre.o' -o 'poserCylindre.so'

echo ""
cd ../scripts
./send_file_to_rpi.sh ../build_arm/IA2017.so
#./send_file_to_rpi.sh ../build_arm/poserCylindre.so
