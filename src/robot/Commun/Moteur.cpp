...
namespace Commun {
	...
	ResultatAction MoteurManager::positionnerNMoteursBloquants(std::vector<std::pair<uint8_t, CarteMoteurs2018::SensRotation>> moteurs,
	...
	ResultatAction MoteurManager::tournerPlusieursOn(std::vector<std::pair<uint8_t, CarteMoteurs2018::SensRotation>> moteurs) {
		for(auto motor : moteurs) {
	...
	ResultatAction MoteurManager::positionnerMoteurBloquant(uint8_t moteur, std::size_t nbr_tours, CarteMoteurs2018::SensRotation sens) {
	...
	ResultatAction MoteurManager::tournerOn(uint8_t moteur, CarteMoteurs2018::SensRotation sens) {
