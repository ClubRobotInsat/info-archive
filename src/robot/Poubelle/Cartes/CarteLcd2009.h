...
#ifndef _CARTE_LCD_2009_H_
#define _CARTE_LCD_2009_H_
...
class CarteLcd2009 : public Carte {
public:
	CarteLcd2009(Commun::CAN& can, uint8_t id) : Carte(can, id), _choixIA(-1), _nombreIAs(0), _lastID(0) {}
