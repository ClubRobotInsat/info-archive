...
#ifndef PETRI_GENERATED_OuvrirReservoir_H
#define PETRI_GENERATED_OuvrirReservoir_H
	...
	namespace Generated {
		namespace OuvrirReservoir {
			...
			inline std::unique_ptr<::Petri::PetriDynamicLib> createLib(std::string const &customPath = "") {
				return std::make_unique<::Petri::MemberPetriDynamicLib>(false, "OuvrirReservoir", 12346, customPath);
			}
		}
	}
}
