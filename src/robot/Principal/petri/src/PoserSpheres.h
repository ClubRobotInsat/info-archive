...
#ifndef PETRI_GENERATED_PoserSpheres_H
#define PETRI_GENERATED_PoserSpheres_H
	...
	namespace Generated {
		namespace PoserSpheres {
			...
			inline std::unique_ptr<::Petri::PetriDynamicLib> createLib(std::string const& customPath = "") {
				return std::make_unique<::Petri::MemberPetriDynamicLib>(false, "PoserSpheres", 12346, customPath);
			}
		}
	}
}
