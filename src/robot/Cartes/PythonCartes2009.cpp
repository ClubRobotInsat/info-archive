...
BOOST_PYTHON_MODULE(Cartes2009) {
	class_<CarteDebug2009 /*Wrap, boost::noncopyable*/>("CarteDebug2009")
	    //	.def("traiterMessage", &CarteDebug2009::traiterMessage, &CarteDebug2009Wrap::default_traiterMessage)
	    .def("traiterMessage", &CarteDebug2009::traiterMessage)
	    .def("EnvoyerPing", &CarteDebug2009::EnvoyerPing)
	    .def("verifierPong", &CarteDebug2009::verifierPong)
	    .def("DemanderPaletARamasser", &CarteDebug2009::DemanderPaletARamasser)
	    .def("verifierPaletARamasser", &CarteDebug2009::verifierPaletARamasser)
	    .def("RamasserPalet", &CarteDebug2009::RamasserPalet)
	    .def("PoserColonne", &CarteDebug2009::PoserColonne)
	    .def("PoserLinteau", &CarteDebug2009::PoserLinteau)
	    .def("RamasserLinteau", &CarteDebug2009::RamasserLinteau);
	...
	class_<CarteDetectAdv2009, bases<CarteAsservissement2009>>("CarteDetectAdv2009")
	    ...
	    .def("getDistance", &CarteDetectAdv2009::getDistance)
