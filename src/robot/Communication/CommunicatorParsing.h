...
namespace Communication::Arguments {
	...
	struct Parser {
		static std::pair<std::type_index, std::unique_ptr<Protocol>> make_protocol(const std::initializer_list<std::string>& args);

		static std::pair<std::type_index, std::unique_ptr<Protocol>> make_protocol(const std::vector<std::string>& args);

		static std::pair<std::type_index, std::unique_ptr<Protocol>> make_protocol(const Constants::RobotInitializationData& robot);
	};
