...
#ifndef ROOT_CALLBACK_H
#define ROOT_CALLBACK_H

#include <cstring>
#include <stdint.h>

#define MBED_DEPRECATED_SINCE(msg1, msg2)
#define MBED_STATIC_ASSERT(arg1, arg2)
...
public:
	 ...
	 */
	template <typename T, typename U>
	MBED_DEPRECATED_SINCE("mbed-os-5.1", "Arguments to callback have been reordered to Callback(func, arg)")
	 ...
	 */
	MBED_DEPRECATED_SINCE("mbed-os-5.4", "Replaced by simple assignment 'Callback cb = func")
	void attach(R (*func)()) {
		this->~Callback();
...
private:
	...
	struct method_context {
		...
		method_context(O* obj, M method) : method(method), obj(obj) {}
	...
	struct function_context {
		...
		function_context(F func, A* arg) : func(func), arg(arg) {}
